...
class LibraryController(
    ...
    suspend fun saveLibraryDocument(
        ...
        @RequestPart("pdf") monoPdfPart: Mono<Part>,
        @RequestPart("index") monoIndexJsonPart: Mono<Part>
    ) {
    ...
    suspend fun Mono<Part>.toDocumentIndexList(): List<DocumentIndex> = flatMap { part ->
