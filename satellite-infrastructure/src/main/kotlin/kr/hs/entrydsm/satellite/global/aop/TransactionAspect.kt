package kr.hs.entrydsm.satellite.global.aop
...
class TransactionAspect(
    ...
    fun transactionAdviceAdvisor(): Advisor {
        ...
        pointcut.expression = "@within(kr.hs.entrydsm.satellite.common.annotation.UseCase)"
    ...
    fun readOnlyTransactionAdviceAdvisor(): Advisor {
        ...
        val pointcut = AspectJExpressionPointcut()
        pointcut.expression = "@within(kr.hs.entrydsm.satellite.common.annotation.ReadOnlyUseCase)"
