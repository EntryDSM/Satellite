package kr.hs.entrydsm.exit.domain.school.useCase
...
import kr.hs.entrydsm.exit.domain.school.persistence.AccessRight
import kr.hs.entrydsm.exit.domain.school.persistence.LibraryDocument
import kr.hs.entrydsm.exit.domain.school.persistence.repository.LibraryDocumentRepository
import kr.hs.entrydsm.exit.domain.school.presentation.dto.CreateLibraryFileResponse
import kr.hs.entrydsm.exit.domain.school.properties.SchoolYearProperties
import kr.hs.entrydsm.exit.global.exception.ForbiddenException
import kr.hs.entrydsm.exit.global.thirdparty.aws.s3.AwsS3Adapter
import kr.hs.entrydsm.exit.global.thirdparty.pdf.PdfAdapter
import kr.hs.entrydsm.exit.global.util.FileUtil.toFileDateFormat
