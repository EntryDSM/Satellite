...
internal class SecurityConfig(
    ...
    companion object {
        private val TEACHER = kr.hs.entrydsm.repo.domain.auth.constant.Authority.TEACHER.name
        private val STUDENT = kr.hs.entrydsm.repo.domain.auth.constant.Authority.STUDENT.name
        private val COMPANY = kr.hs.entrydsm.repo.domain.auth.constant.Authority.COMPANY.name
    }
